...
## I've added the next two lines for more convenient downstream processing - A.P.
param_out <- cbind(essen,ambig) 
write.table(param_out, file=paste(input, "param", "out", sep="."),sep="\t",quote=F,row.names=F)
